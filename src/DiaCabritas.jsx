...
const fotos = [
  // 🟦 FOTOS VERTICALES
  { id: 11, src: "/foto11.webp", texto: "Mi host family hizo una comida para todas nosotras y terminamos el día viendo el atardecer con las chiquillas. Al final me caí por las escaleras y la única que lo vio fuiste tú, típico 🤣" },
  { id: 13, src: "/foto13.webp", texto: "Karito y yo en Downtown Nevada City, Karely nos sacó esa foto, y no entiendo por qué yo colocaba esas caras jajaja. Al principio era toda tímida, nomás te hacía reír… y ahora quién me saca de encima, ahhh 😅" },
  ...
  { id: 12, src: "/foto12.webp", texto: "Yuba River siempre será nuestro lugar. No sé cuántas veces fuimos este verano, pero lo pasamos la raja: nadamos, comimos y nos reímos mucho hablando de toda la gente que estaba desnuda jajaja." },
  { id: 15, src: "/foto15.webp", texto: "En New Year’s Eve, Sofi y Karito despidiendo el 2024 siendo loquitas toda la noche 😂" },
  { id: 16, src: "/foto16.webp", texto: "Karito y yo empezando el 2025 con risas y todas loquitas, yo por poco casi me quedo sin cabello también 😂" },
  ...
  { id: 30, src: "/foto30.webp", texto: "Fuimos a la feria, reíamos para no llorar y recordar que gastamos 60 dólares en un peluche todo picho 🫠 Pero la pasamos increíble, nos subimos al Freakout y al ascensor 🎡" },
  { id: 21, src: "/foto21.webp", texto: "Primera vez que fuiste al Yuba River, estuvo espectacular. Comimos cerca del río, tomamos nap, yo me metí al agua a medias y tú decías que estaba muy fría, jaja 😂" },
  { id: 23, src: "/foto23.webp", texto: "Primero fuimos a hacer hiking con las chiquillas cerca de donde ahora vives, y es re loquito pensar eso… quién hubiera sabido. Luego fuimos a jugar pickleball, la Sofi nos ganó con toda, hasta rompió una de las pelotas jajaja." },
  ...
  { id: 53, src: "https://res.cloudinary.com/dwmw7ftnu/image/upload/v1759606211/IMG_1971_mnzzam.jpg", texto: "We love you Karo!", title: "Luke & Gretta" },
  { id: 31, src: "/foto31.webp", texto: "El día después de que llegaste de New York tuviste un viaje largo, pero lleno de amor con tu mamita. Me pone contenta que te reencontraras con ella y que puedan disfrutar juntas. También hicimos pizza en forma de corazón y comimos cupcakes que habían sobrado del cumpleaños de Liliana" },
  ...
  { id: 18, src: "https://res.cloudinary.com/dwmw7ftnu/image/upload/6318340043517053773_pyd4kn.jpg", texto: "Tarde espectacular con tus hosts y los Gookins en Yuba River. Recuerdo haberme reído muchísimo con Luke y contigo, sobre todo con él, cuando saltó de las piedras mientras nos pedía que le cantáramos Mystical Magical de Benson Boone 😆" },
  { id: 18, src: "https://res.cloudinary.com/dwmw7ftnu/image/upload/IMG_1742_iv8ygz.jpg", texto: "I like this solo of Karo", title: "-Lisa" },
  { id: 18, src: "https://res.cloudinary.com/dwmw7ftnu/image/upload/v1759607427/IMG_0647_ndguds.jpg", texto: "Las montañas y la naturaleza siempre serán parte de ti, y dondequiera que vayas encontrarás tu lugar. Otra foto que me gusta de ti" },
  ...
  { id: 18, src: "https://res.cloudinary.com/dwmw7ftnu/image/upload/v1759605352/IMG_1872_ln3see.jpg", texto: "Thank you for being the best babysitter ever! We appreciate you so much and love playing pickleball and biking and cuddling on the couch (sometimes with Hollow Knight). We love you.", title: "-Luke" },
  { id: 18, src: "https://res.cloudinary.com/dwmw7ftnu/image/upload/v1759605800/IMG_1758_zqrs1r.jpg", texto: "Karo, your kindness, generosity and energy are expansive. We're so happy you joined our wacky Sandoz family for a few months this year. From bike rides to pickleball to yummy dinners, music sessions and jumps in the river, we love you and are so excited to hear about all of your adventures as you head back to Columbia! You're an amazing woman and I know you'll do great things.", title: "-Lisa & Devin" },
];
        ...
        {fotos.map((foto) => (
          <div key={foto.id} className="col-md-6 col-lg-4 mb-4">
            ...
            <img
                ...
                style={{
                  height: foto.orientation === "horizontal" ? "400px" : "400px",
                  objectFit: "cover",
                }}
                 loading="lazy"
/>
