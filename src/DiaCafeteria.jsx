...
function DiaCafeteria() {
  return (
    <div className="container py-5 text-center">
      ...
      ✨ Una pijamada que disfruté muchísimo. Ese día conocí a Sofí y la pasamos increíble. Recuerdo que llevé un vino para preparar algo y aunque no resultó como esperaba  igual nos reímos mucho. Jugamos UNO, conversamos de todo y compartimos momentos únicos. Sofi me hablaba de piedras y de ciencia, algo que le apasionaba, mientras Tu me contabas sobre su familia. Yo las escuchaba y sentía lo especial y lo buenas que serian para mi ✨
      </p>
      <div className="row">
        {fotos.map((foto) => (
