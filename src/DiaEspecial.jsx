...
const fotos = [
  ...
  { id: 65, src: "/foto65.webp", descripcion: "Este fue un día muy divertido, el cumpleaños de Jipa, nos reímos, bailamos, comimos y disfrutamos bastante. Ari pudo acompañarnos ese día, y fueron muchas risas, y una noche sin dormir mucho jajaja, fue una experiencia muy linda!",
  title: "-Sofi",
   },
  ...
  { id: 56, src: "/foto56.webp", descripcion: "Tu , Sofi y Ari New Year's Eve 2024."},
  ...
  { id: 67, src: "/foto67.webp", descripcion: "Aquí fuimos a despejarnos un poco del trabajo y a ver el atardecer juntas  en el Dorado hills, tuvimos un pequeño picnic y disfrutamos el tiempo hasta que cerró el lugar.",
  title: "-Sofi",
   },
  { id: 39, src: "/foto39.webp", descripcion: "Esta fue la primera vez que hicimos un hiking juntas, fuimos a Sly Park, y la pasamos muy lindo, charlando encontramos que teníamos muchas cosas en común, y desde ahí empezamos a vernos muy seguido 🤗",
  title: "-Sofi",
   },
  ...
  { id: 48, src: "/foto48.webp", descripcion: "Nuestro primer Halloween juntas, estuvimos con nuestras familias ese día en Placerville, luego comimos algo y fuimos a ver las decoraciones en las casas, fue un día muy divertido, vimos muchas cosas, nos dieron comida también, y obvio que no puede faltar cuando perdimos el auto a la vuelta, hacía mucho frío, no se veía nada y pensamos que habían robado el auto, que manera de caminar ese día, algunos sustos pero muchas risas 😅",
  title: "-Sofi",
   },
  ...
  { id: 68, src: "/foto68.webp", descripcion: "Aquí salimos de fiesta con otras au pairs, la pasamos muy lindo, mucho baile y muchas risas. Disfrutamos hasta tarde, y volvimos con Ari y a la salida comimos unos tacos, ya que era tarde y no pudimos ir al in and out por unas hamburguesitas." },
  ...
  { id: 69, src: "/foto69.webp", descripcion: "Aquí fue cuando fuimos a cabalgar juntas, tus host te habían regalado dos tickets por tu cumpleaños y me invitaste a ir contigo. La pasamos muy lindo, experiencia increíble y luego un poco de dolor de piernas y otras partes del cuerpo 😅",
  title: "-Sofi",
   },
